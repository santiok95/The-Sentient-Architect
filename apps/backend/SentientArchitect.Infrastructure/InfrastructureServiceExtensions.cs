        ...
        IConfiguration configuration)
    {
        ...
        services
            ...
            .AddJwtBearer(options =>
            {
                ...
                // SignalR sends the token as a query param when WebSocket/SSE transport is used
                // because browsers can't set custom headers on those connections.
...
#pragma warning restore SKEXP0001
        ...
        services.AddScoped<TrendsPlugin>();
