...
public sealed class ProfilePlugin(IApplicationDbContext db, IUserAccessor userAccessor)
{
    ...
    public async Task<string> GetUserProfileAsync(CancellationToken cancellationToken = default)
    {
